...
import styles from "./recomendacoes-ia.module.css";
      ...
      <div className={styles.panel}>
        <div className={styles.acessoRestrito}>
          ...
          <p className={styles.vazio}>
            As recomendações de IA são uma visão gerencial por setor. Peça ao administrador
  ...
  return (
    <>
      <div className={styles.sectionHeader}>
        <div>
          <h2 className={styles.sectionTitle}>Recomendações IA</h2>
...
export default function RecomendacoesIaPage() {
